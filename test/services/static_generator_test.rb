...
class StaticGeneratorTest < ActiveSupport::TestCase
  ...
  test "config change detected" do
    ...
    SiteConfig.create_or_update(file_path: "site/system/site.yml", config: { "title" => "Updated" })
  ...
  test "config change triggers full regeneration flag" do
    ...
    SiteConfig.create_or_update(file_path: "site/system/site.yml", config: { "title" => "New" })
    SiteConfig.last.touch
