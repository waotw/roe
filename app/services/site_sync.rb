module SiteSync
  ...
  #   site.yml `sync_transport: http` or unset → :http (the default —
  #     host-agnostic HTTP is now the recommended transport). Installs that
  #     want the old SSH/rsync path set `sync_transport: rsync` explicitly.
