...
Roe supports two deployment options: **[Fly.io](https://fly.io)** (recommended for hands-off deployment, a little pricier) and **[Kamal](https://kamal-deploy.org/)** which works on any host that supports VPS like DigitalOcean (recommended for bring-your-own-host, not too much more work).
