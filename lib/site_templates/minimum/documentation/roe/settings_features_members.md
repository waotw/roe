---
roe_version: 0.0.26
title: "Settings → Features: Members"
status: published
---

# Membership & Paid Content Settings
...
Set your active theme. You can also do this from the [Themes](/admin/themes) which will update this setting as well.
