...
This is a great way to learn how things work as you can see the changes live. Try out [Collections](#collections), [Cards](#cards), [Image Galleries](#image-gallaries). There is also a list of [tutorials](#tutorials-to-get-you-started)
...
Collections, Cards and Image Galleries

### Collections

A Collection is a list of posts. In Roe, you can add them anywhere with a simple syntax. And you can customize them to create any kind of post collection you want. [Learn more about Collections →](/documentation/collections)

Collections are generally added to Pages since they're collections of posts but you could put a Collection into any Post.
